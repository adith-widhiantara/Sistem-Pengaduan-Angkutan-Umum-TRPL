						...
						<div class="row">
							...
							<div class="col-md-10">
								...
								<p>
									...
									<span class="float-right"><i class="text-warning fa" style="font-size: 30px"> {{ $pengaduan1->rating }}</i></span>
								</p>
								...
								<p><strong><small>Perkiraan Waktu Kejadian : </small> {{ $pengaduan1->waktu }}</strong></p>
