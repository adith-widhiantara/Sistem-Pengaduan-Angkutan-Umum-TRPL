    ...
    <div class="container-fluid">
        <div class="container">
            ...
            <div class="card card-info border-primary mb-3">
                ...
                <form method="post" action="{{ route('ubahpengaduan2.update', $pengaduan2->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    <div class="card-body">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" id="judul" name="judul" value="{{ $pengaduan2->judul }}" class="form-control" placeholder="Judul Pengajuan" required>
                        </div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <textarea type="text" id="uraian" name="uraian" class="form-control" placeholder="Uraian Pengajuan" rows="5" required>{{ $pengaduan2->uraian }}</textarea>
                        </div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" id="nama" name="nama" value="{{ $pengaduan2->nama}}" class="form-control" placeholder="Nama Bus" required>
                        </div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" id="nomor" name="nomor" value="{{ $pengaduan2->nomor}}" class="form-control" data-inputmask="'mask': ['AA-9999-AA']" data-mask required>
                        </div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="form-control" id="tempat" name="tempat" value="{{ $pengaduan2->tempat }}" required>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <div class="custom-file">
                                ...
                                <input type="hidden" name="hidden_image" value="{{ $pengaduan2->foto }}">
